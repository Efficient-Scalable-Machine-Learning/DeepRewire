...
def verify_number_of_connections(optimizer):
    ...
    assert active_connections == optimizer.nc, f"Expected {
        optimizer.nc} active connections, found {active_connections}"
...
def test_training_time():
    ...
    print(f"Regular SGD time: {
          regular_time:.4f}s, DEEPR time: {rewired_time:.4f}s")
